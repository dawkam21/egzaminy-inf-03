...
<body>
    ...
    <main>
        ...
        <section class="master">
            ...
            <!-- SKRYPT 2 -->
                <?php
                    $q2 = "SELECT DISTINCT swinki.data_ur, swinki.miot, rasy.rasa FROM swinki JOIN rasy ON swinki.rasy_id = rasy.id WHERE rasy.id = 7;";
            ...
            <!-- SKRYPT 3 -->
                <?php
                    $q3 = "SELECT imie, cena, opis FROM swinki WHERE rasy_id = 7;";
